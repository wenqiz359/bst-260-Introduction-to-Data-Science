...
5.  Create a directory called `docs`. Use the command `install.packages('tinytex')` to create a PDF and save it to the `docs` directory. Show use the command you typed:
